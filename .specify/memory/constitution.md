...
| `autonomous-run-governance` | `v0.4.3` | `70` | permission-bounded, evidence-first governance with optional intake gate and resumable, validated closeout |
...
**Version**: 1.18.2 | **Ratified**: 2026-03-31 | **Last Amended**: 2026-09-12
