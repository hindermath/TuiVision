...
- a retained `Completed` series with archived members and zero eligible targets
  under `SeriesManifest`, plus negative active-Completed, archived-Eligible,
  eligible, and pending terminal fixtures;
