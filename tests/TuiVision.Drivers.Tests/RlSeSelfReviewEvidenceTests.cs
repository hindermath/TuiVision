...
{
    private const string AuditDirectory = "docs/security/secure-development/2026-09-12-rl-se-checklist-self-review-v044";
    ...
    [
        ...
        "model-routing-governance@0.1.4", "intake-authoring-governance@0.3.4", "intake-review-governance@0.2.3",
        "intake-sequencing-governance@0.2.6", "autonomous-run-governance@0.4.4",
