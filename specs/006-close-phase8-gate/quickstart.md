...
5. Run the mandatory quality gates before the closure commit:
...
6. If public APIs or XML comments changed, run the conditional documentation
   gate:
...
7. Refresh compatibility evidence:
...
8. Reconcile the final proof package across:
...
- Core, Controls, and Serialization each meet or exceed 70% line coverage.
