...
6. Every inventory item has one domain and at least one valid contract.
...
9. Drift/gap contracts have exactly one complete finding; other contracts have none.
...
- Feature 027 remains mandatory and cannot pass with an unresolved Critical or
  High finding.
