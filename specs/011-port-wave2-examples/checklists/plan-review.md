...
- [ ] CHK001 Sind alle elf Welle-2-Beispiele aus `FR-001` im Plan abgedeckt:
...
- [ ] CHK002 Hat jedes Welle-2-Beispiel einen geplanten Projektpfad, eine
...
- [ ] CHK003 Ist der Pfad vom Pflichtenheft-Eintrag zu Beispiel, Guide und
...
- [ ] CHK004 Ist klar geregelt, dass Welle 3 erst nach vollstaendigem Welle-2-
...
- [ ] CHK005 Ist der Punkt "Historical Example Parity Cleanup" klar vom
...
- [ ] CHK006 Ist `sdlg` eindeutig als historisches vertikales
...
- [ ] CHK007 Ist `sdlg2` eindeutig als historisches horizontal und vertikal
...
- [ ] CHK008 Ist Standarddialog-Nachweis `demo`, `dlgdsn` oder einem anderen
...
- [ ] CHK009 Sind Editor, Hilfe, Streams, Terminalemulation, Runtime-Maus,
...
- [ ] CHK010 Ist Dateiinhalt-I/O aus Standarddialog-Acceptance ausgeschlossen,
...
- [ ] CHK011 Ist "example-specific deterministic interaction" so definiert,
...
- [ ] CHK012 Ist `dlgdsn` auf strukturierte Dialogbeschreibung laden/erzeugen,
...
- [ ] CHK013 Verwenden Plan, Research, Datenmodell, Contract und Quickstart
...
- [ ] CHK014 Stimmen die Smoke-Test-Erwartungen in Spec, Plan, Datenmodell,
...
- [ ] CHK015 Passen die Quickstart-Validierungskommandos zur Teststrategie und
...
- [ ] CHK016 Sind Architektur-, Security-, A11Y-, Statistik- und
...
- [ ] CHK017 Bleibt die vorhandene `plan-quality.md` mit dieser tieferen
...
- [ ] CHK018 Ist jedes messbare Erfolgskriterium `SC-001` bis `SC-009` auf ein
...
- [ ] CHK019 Ist das Guide-Ziel messbar als vier vorhandene Guides plus elf
...
- [ ] CHK020 Ist Smoke-Coverage fuer alle fuenfzehn gelieferten Beispiele nach
...
- [ ] CHK021 Sind alle geforderten Interaktionsfamilien abgedeckt: Clipboard,
...
- [ ] CHK022 Sind Progress-Ergebnisse objektiv genug, um zeitabhaengige
...
- [ ] CHK023 Sind Abbruch, Schliessen, ungueltige Auswahl und fehlgeschlagene
...
- [ ] CHK024 Sind fehlende, nicht lesbare, manuell eingegebene oder ungueltige
...
- [ ] CHK025 Werden fehlerhafte oder unvollstaendige dynamische
...
- [ ] CHK026 Sind leere, sehr kleine oder randwertige Inhalte fuer Listen,
...
- [ ] CHK027 Ist nicht verfuegbarer oder isolierter Clipboard-Zugriff als
...
- [ ] CHK028 Werden host-sensitive historische Verhaltensweisen ueber
...
- [ ] CHK029 Nutzt der Plan die Level-2-TuiVision-Umgebung und .NET 10/C# 14
...
- [ ] CHK030 Ist C# als primaere speichersichere Sprache festgehalten, sodass
...
- [ ] CHK031 Bleiben NIST SSDF und CWE Top 25 anwendbar, waehrend OWASP ASVS
...
- [ ] CHK032 Sind Supply-Chain-, SBOM/VEX/SLSA- und Dependency-Aussagen zum
...
- [ ] CHK033 Ist Architektur-Evidence unter `docs/architecture/` mit konkreten
...
- [ ] CHK034 Ist A11Y auf text-first und keyboard-first Terminalverhalten plus
...
- [ ] CHK035 Sind DE-first, EN-second und CEFR-B2 an jeden lernorientierten
...
- [ ] CHK036 Ist `docs/project-statistics.md` als Completion-Artefakt geplant
...
- [ ] CHK037 Ist der Multi-Agent-Context-Refresh fuer Codex, Claude, Gemini und
...
- [ ] CHK038 Werden die Voraussetzungen aus `008-controls-revision`,
...
- [ ] CHK039 Sind wiederverwendbare Framework-Aenderungen auf bestehende
...
- [ ] CHK040 Ist die Implementierungsphase fuer Red-Green-Refactor-Aufgaben
...
- [ ] CHK041 Sind die Validierungskommandos ausreichend, aber fuer die
...
- [ ] CHK042 Gibt es keine offenen Platzhalter wie `TODO`, `TBD`,
  `NEEDS CLARIFICATION` oder Beispiel-Checklistenpunkte mehr in den Feature-
  Artefakten? [Qualitaet, alle Feature-Artefakte]
  - Durchfuehrungshinweis: Suche im Feature-Verzeichnis nach offenen
    Platzhaltern und pruefe, dass alle Checklisteneintraege feature-spezifische
    Review-Punkte sind.

- [ ] CHK043 Muessen zurueckgestellte oder bewusst reduzierte historische
...
- [ ] CHK044 Ist der Plan ohne weitere Klaerungsrunde bereit fuer
