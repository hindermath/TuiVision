...
- **Spec-Kit presets**: PASS. The C#/.NET Level-2 default applies: `security-governance` v0.4.0, `architecture-governance` v0.2.0, `isaqb-architecture-governance` v0.1.0, `a11y-governance` v0.2.0, `cross-platform-governance` v0.1.0, and `agent-parity-governance` v0.2.0.
