...
<!-- SPECKIT START -->
For the active Feature 028 context, use
`specs/028-pre-wave5-wave6-conformance-closure/plan.md` as the implementation
plan. Keep Wave 5 and Wave 6 blocked and proceed only to the Feature-029
Terminal.GUI audit after this closure is merged and synchronized.
<!-- SPECKIT END -->
