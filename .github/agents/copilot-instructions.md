...
- Current planning status: Feature 034 is active on `034-wave5-combined-delta-closure`; binding plan and design artifacts live under `specs/034-wave5-combined-delta-closure/`.
