...
eine nachvollziehbare Selbstpruefung, ob TuiVision die Anforderungen aus
...
TuiVision ist ein Repository in der Level-1-/Level-2-Arbeitsstruktur.
...
- `Applicable`: gilt fuer TuiVision und braucht Evidenz oder Umsetzung.
...
Nutze requirements/intakes/active/Lastenheft_RL-SE-Checklist-Selbstpruefung.md als verbindlichen Intake fuer einen separaten RL-SE-/Checklist-Selbstpruefungslauf in TuiVision.
...
```text
Ersetzter Alt-Prompt: speckit-autonomous Use `requirements/intakes/active/Lastenheft_RL-SE-Checklist-Selbstpruefung.md` as the
