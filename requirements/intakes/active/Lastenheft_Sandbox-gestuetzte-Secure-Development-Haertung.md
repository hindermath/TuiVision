...
```text
Ersetzter Alt-Prompt: speckit-specify Nutze requirements/intakes/active/Lastenheft_Sandbox-gestuetzte-Secure-Development-Haertung.md als verbindliche Eingabedatei. Erstelle die Feature-Spezifikation fuer einen Sandbox-gestuetzten Secure-Development-Haertungslauf im Repository TuiVision.
...
`requirements/intakes/active/Lastenheft_Sandbox-gestuetzte-Secure-Development-Haertung.md` as the binding
