...
```text
Ersetzter Alt-Prompt: speckit-specify Nutze requirements/intakes/active/Lastenheft_Constitution_Change.md als verbindliche Eingabe. Erstelle die Feature-Spezifikation fuer eine Governance-Aenderung zu didaktischer und sprachlicher Klarheit in TuiVision.
...
```text
Ersetzter Alt-Prompt: speckit-autonomous Use `requirements/intakes/active/Lastenheft_Constitution_Change.md` as the binding
